...
<header >
		...
		<ul class="my-auto">
			<li><a href="index_lgn.php">Data Aset Laptop</a></li>
			<li><a href="logout.php">Logout</a></li>
		</ul>
	</header>
	<div class="bg" id="homelgnpc">
            				...
            				<tbody>
                				<div>
                    				<tr>
                        				...
                        				<td><?= $row["jumlah"];?></td>
                                        <td>
                                            <a class="btn btn-dark" href="edit_pc.php?id=<?= $row["id"];?>">Edit</a>
...
<div class="container mx-auto">
  <footer class="py-0 my-0">
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class="nav-item"><a href="#homelgnpc" class="nav-link px-2 text-muted">Home</a></li>
